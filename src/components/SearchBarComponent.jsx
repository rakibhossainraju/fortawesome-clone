...
function SearchBarComponent() {
  ...
  return (
    <div className="w-[80%] py-5 text-center">
      <span className="group relative inline-block w-10/12 ">
        <svg
          className="absolute left-6 top-1/2 aspect-square w-[18px] -translate-y-1/2 fill-blue-1000 group-focus-within:fill-blue-400"
        ...
        <input
          className="w-full rounded-full border-2 border-blue-1000 p-4 pl-14 outline-4 outline-blue-400 focus:shadow-[0_0_5px_1px_#60a5faff]"
          type="text"
